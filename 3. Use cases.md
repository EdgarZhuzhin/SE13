...
* What can go wrong: 
  ...
  In scenarios 2 and 3 it is possible that the person, whose location the user wants to see on the map, logs out at the same moment when the user is redirected to the map screen. In this scenario, the person's location cannot be shown. If that person is offline, nothing happens.
