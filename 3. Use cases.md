...
When the user logs in as an ordinary user (not the administrator) he or she becomes a registered user. 

**Administrator**
Administrator can log in using the same log in form as registered users. Administrator has all the same access as registered users. In addition to that he or she can access all the user information and manage users and the content.
