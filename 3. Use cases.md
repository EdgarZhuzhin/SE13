...
![Use case diagrams](https://github.com/rosasuominen/SE13/blob/master/UseCaseDiagram.jpg)
...
* What can go wrong: 
  ...
  No errors exist for logging out.
...
* What can go wrong: 
  ...
  No errors exist for deleting accounts.
...
* What can go wrong:
  ...
  No errors exist for deleting friends.

* Other activities going on at the same time:

  Friend status of the selected user is deleted from the database.
...
**"User wants to delete foes"**
  ...
  User can delete foes in the same way as adding them. In this case they click the bright red button, which makes it turn back to a light red button. After this that user is deleted from the foes list.
...
![One use case as a flow chart](https://github.com/rosasuominen/SE13/blob/master/flowchart.png)
